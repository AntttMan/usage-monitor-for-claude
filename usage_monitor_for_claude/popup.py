...
def _credits_summary(usage: dict[str, Any]) -> dict[str, Any] | None:
    ...
    # Billing currency reported by the API (upstream v1.18) — falls back to the
    # system locale when absent.
    ...
    summary: dict[str, Any] = {
        ...
        'limit_text': (format_credits(limit, currency, decimal_places)
                       if is_finite_limit else T['credits_unlimited']),
        'balance_text': (format_credits(balance, currency, decimal_places)
